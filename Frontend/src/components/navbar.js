...
const Navbar = () => {
  ...
  return (
    <div className={`fixed top-0 z-50 w-full h-[70px] flex justify-between items-center px-4 text-black ${isScrolled ? "bg-white" : "bg-transparent"}`} >
      <div className="text-4xl cursor-pointer inline-flex items-center text-fuchsia-800 font-bold">
      ...
      <div className="hidden md:flex">
        ...
        <button className="px-4 py-2 bg-fuchsia-800 text-white rounded-md hover:bg-fuchsia-900 hover:text-white mx-2">
      ...
      <div
        ...
        } md:hidden flex flex-col bg-fuchsia-800 text-white w-full absolute top-16 left-0 z-10`}
      >
