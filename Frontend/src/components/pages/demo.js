...
const Demo = () => {
  return (
    <div id="demo" className="flex flex-col md:flex-row w-full h-screen bg-fuchsia-800">
      <div className="w-full md:w-1/2 p-4 md:p-8 bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">Real  <span className="text-fuchsia-700">Estate</span> Video</h1>
