        ...
        <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <div className="bg-white rounded-lg shadow-lg">
              ...
              <div className="py-6 px-4">
                ...
                <p className="text-lg font-bold text-gray-700 mt-4">5 Crore </p>
                <button className="mt-6 px-4 py-2 bg-fuchsia-600 text-white rounded-md hover:bg-fuchsia-800">
                  View Details
                </button>
              </div>
            </div>
          ...
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <div className="bg-white rounded-lg shadow-lg">
              ...
              <div className="py-6 px-4">
                <h3 className="text-lg font-medium text-gray-900">456 Main St</h3>
                <p className="text-sm text-gray-500">4 bd | 3 ba | 2,000 sqft</p>
                <p className="text-lg font-bold text-gray-700 mt-4">7.5 Crore</p>
                <button className="mt-6 px-4 py-2 bg-fuchsia-600 text-white rounded-md hover:bg-fuchsia-800">
                  View Details
                </button>
              </div>
          ...
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            <div className="bg-white rounded-lg shadow-lg">
              ...
              <div className="py-6 px-4">
                ...
                <p className="text-lg font-bold text-gray-700 mt-4">3 Crore</p>
                <button className="mt-6 px-4 py-2 bg-fuchsia-600 text-white rounded-md hover:bg-fuchsia-800">
                  View Details
                </button>
              </div>
