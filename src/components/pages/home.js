  ...
  return (
    <div id="home" className="w-full min-h-screen p-8 flex items-center bg-gradient-to-b from-white to-fuchsia-100">
      <div className="max-w-7xl mx-auto md:flex md:flex-row-reverse md:items-center">
        ...
        src={Image}
        alt="Home"
        className="w-full h-auto object-cover rounded-lg md:rounded-lg shadow-lg"
        />
        </div>
        <div className="md:w-1/2 md:pl-8">
          <div className="text-center md:text-left">
            <h1 className="text-4xl font-bold text-black mb-6">Find Your <span className="text-fuchsia-700">Dream Home</span></h1>
          ...
          <form className="flex flex-col md:flex-row gap-4">
            ...
            />
            <button className="px-6 py-3 bg-fuchsia-700 text-white rounded-full shadow-lg hover:bg-fuchsia-800">
              Get Started
            </button>
          </form>
          </div>
