      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <form action="#" method="POST" className="grid grid-cols-1 gap-y-6">
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                className="py-3 px-4 block w-full shadow-sm focus:ring-fuchsia-800 focus:border-amber-800 border border-fuchsia-800 rounded-md"
              />
            </div>
          </div>
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                type="email"
                autoComplete="email"
                className="py-3 px-4 block w-full shadow-sm focus:ring-fuchsia-800 focus:border-fuchsia-800 border border-fuchsia-800 rounded-md"
              />
            </div>
          </div>
          <div>
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-lg font-medium rounded-md text-white bg-fuchsia-800 hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-fuchsia-800"
            >
              Send Message
            </button>
          </div>
